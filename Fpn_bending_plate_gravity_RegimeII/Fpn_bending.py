...
mdb.models['Model-1'].Part(dimensionality=THREE_D, name='Board', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].parts['Board'].BaseSolidExtrude(depth=1.0, sketch=
...
mdb.models['Model-1'].parts['Board'].Set(faces=
    mdb.models['Model-1'].parts['Board'].faces.findAt(((80.0, 16.666667, 0.0), 
    )), name='Set-BoardFace')
mdb.models['Model-1'].parts['Board'].Set(faces=
    mdb.models['Model-1'].parts['Board'].faces.findAt(((40.0, 16.666667, 1.0), 
    )), name='Set-BoardBC')
